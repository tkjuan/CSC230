...
//static const char rwNav[] = "<head><title> Robot Movement Page </title></head><body><div id='navButtons'><div><button id='forward' onclick=\"window.location.href=\'forward\'\">forward</button></div><div><button id='left' onclick=\"window.location.href=\'left\'\">left</button><button id='right' onclick=\"window.location.href=\'right\'\">right</button></div><div><button id='back' onclick=\"window.location.href=\'back\'\">back</button></div><div><button id='half' onclick=\"window.location.href=\'half\'\">half</button><button id='full' onclick=\"window.location.href=\'full\'\">full</button></div></div><style>button{font-size: 100px;height:200px;width:50%;}div{text-align:center;width:100%;}</style>";
static const char rwNav[] = "<head><title> Robot Movement Page </title></head><body><style>button{font-size: 80px;height:100px;width:50%;}div{text-align:center;width:100%;}img{border: 3px solid #73AD21;z-index: -1;-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;}#navbuttons{margin-bottom: 100px;}#forward{margin:auto;text-align:center;}#leftright{text-align:center;}#back{text-align:center;}#bLeft {-ms-transform: rotate(-90deg);-webkit-transform: rotate(-90deg);transform: rotate(-90deg);}#bRight {-ms-transform: rotate(90deg);-webkit-transform: rotate(90deg);transform: rotate(90deg);}#bDown {-ms-transform: rotate(180deg);-webkit-transform: rotate(180deg);transform: rotate(180deg);}</style><body><div id= 'navbuttons'><div id='forward'><img onclick=\"window.location.href=\'forward\'\" id='bUp' class='button' src='Arrowup.jpg' alt='Arrowup' width='100px' height='100px' ></div><div id='leftright'><img id='bLeft' class='button' onclick=\"window.location.href=\'left\'\" src='Arrowup.jpg' alt='Arrowleft' width='100px' height='100px' style='margin-right:100px'><img id='bRight' class='button' onclick=\"window.location.href=\'right\'\" src='Arrowup.jpg' alt='Arrowright' width='100px' height='100px' ></div><div id='back'><img id='bDown' class='button' onclick=\"window.location.href=\'back\'\" src='Arrowup.jpg' alt='Arrowdown' width='100px' height='100px'></div></div><div><button id='half' onclick=\"window.location.href=\'half\'\">half</button><button id='full' onclick=\"window.location.href=\'full\'\">full</button></div></body></html>";
